# Từ điển tổng hợp (txt)

Chỉ chứa các file txt tổng hợp, không kèm thư mục nguồn (`nguon`).

## Các file

| File | Nội dung | Dung lượng |
|------|----------|-----------|
| `tu_dien/1_vp/VietPhrase.txt` | VietPhrase | ~47 MB |
...
- Tải toàn bộ repo dạng zip (chỉ có các file txt trên):
  https://github.com/ducbui0/tong-hop-tu-dien/archive/refs/heads/main.zip

- Hoặc tải từng file raw:
  - https://raw.githubusercontent.com/ducbui0/tong-hop-tu-dien/main/tu_dien/1_vp/VietPhrase.txt
  - https://raw.githubusercontent.com/ducbui0/tong-hop-tu-dien/main/tu_dien/2_name/Name.txt
